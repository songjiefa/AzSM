...
{
    public abstract class AzSMWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AzSMWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AzSMWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AzSMDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AzSMDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AzSMDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AzSMDbContext, Task<T>> func)
        {
            T result;
